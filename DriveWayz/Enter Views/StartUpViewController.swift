...
class StartUpViewController: UIViewController, UIScrollViewDelegate, LoginButtonDelegate {
    ...
    var accept: UIButton = {
        ...
        button.setTitle("Agree to Terms", for: .normal)
    ...
    func setupTerms() {
        ...
        termsContainer.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -40).isActive = true
