...
class MobileNumberViewController: UIViewController, handlePhoneNumberVerification {
    ...
    var areaCodeView: UIView = {
        ...
        view.layer.borderColor = Theme.BLACK.withAlphaComponent(0.2).cgColor
    ...
    var phoneNumberTextField: UITextField = {
        ...
        field.backgroundColor = Theme.BACKGROUND_GRAY
    ...
    var mainButton: UIButton = {
        let button = UIButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.backgroundColor = Theme.BLACK.withAlphaComponent(0.1)
        button.layer.cornerRadius = 4
    ...
    @objc func deletePressed() {
        ...
        UIView.animate(withDuration: animationIn) {
            self.mainButton.backgroundColor = Theme.BLACK.withAlphaComponent(0.1)
