...
class AirbnbMainController: UITabBarController {
    ...
    var tabBarTextAttributesNormal = [kCTFontAttributeName: UIFont.systemFont(ofSize: 8), kCTForegroundColorAttributeName: UIColor.black]
    var tabBarTextAttributesSelected = [kCTFontAttributeName: UIFont.systemFont(ofSize: 8), kCTForegroundColorAttributeName: UIColor(r: 255, g: 90, b: 95)]
    ...
    func setupTabBar() {
        ...
        UITabBarItem.appearance().setTitleTextAttributes(tabBarTextAttributesNormal as [NSAttributedStringKey : Any], for: .normal)
        UITabBarItem.appearance().setTitleTextAttributes(tabBarTextAttributesSelected as [NSAttributedStringKey : Any], for: .selected)
    }
