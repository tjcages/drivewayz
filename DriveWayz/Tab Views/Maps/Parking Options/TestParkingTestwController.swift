...
class TestParkingTestViewController: UIViewController, handleTestParking {
...
//        view.isPagingEnabled = true
    ...
    lazy var primeController: TestOneOptionViewController = {
        let controller = TestOneOptionViewController()
    ...
    lazy var bestPriceController: TestOneOptionViewController = {
        let controller = TestOneOptionViewController()
        controller.view.translatesAutoresizingMaskIntoConstraints = false
        controller.delegate = self
    ...
    lazy var standardController: TestOneOptionViewController = {
        let controller = TestOneOptionViewController()
        controller.view.translatesAutoresizingMaskIntoConstraints = false
        controller.delegate = self
...
//                self.bookSpotButton.setTitle("BECOME A HOST", for: .normal)
    ...
    @objc func expandPrimeSpot() {
        if let parking = self.primeParking {
            self.delegate?.didTapParking(parking: parking)
        }
    }
...
extension TestParkingTestViewController: UIScrollViewDelegate {
