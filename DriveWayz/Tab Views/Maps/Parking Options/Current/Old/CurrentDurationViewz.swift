...
class CurrentDurationViewz: UIViewController {
...
//    var delegate: mainBarSearchDelegate?
    ...
    func setupViews() {
        ...
        durationBackground.heightAnchor.constraint(equalToConstant: 6).isActive = true
        ...
        durationLine.topAnchor.constraint(equalTo: durationBackground.topAnchor, constant: 1).isActive = true
        durationLine.leftAnchor.constraint(equalTo: durationBackground.leftAnchor, constant: 1).isActive = true
        durationLine.bottomAnchor.constraint(equalTo: durationBackground.bottomAnchor, constant: -1).isActive = true
