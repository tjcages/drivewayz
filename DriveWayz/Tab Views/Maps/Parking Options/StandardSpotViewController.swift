//
//  StandardSpotViewController.swift
//  DriveWayz
//
...
class StandardSpotViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func setupViews() {
        ...
        parkingImageView.widthAnchor.constraint(equalTo: parkingImageView.heightAnchor, constant: 28).isActive = true
        
        container.addSubview(distanceLabel)
        distanceLabel.topAnchor.constraint(equalTo: parkingImageView.topAnchor).isActive = true
        distanceLabel.leftAnchor.constraint(equalTo: container.leftAnchor, constant: 8).isActive = true
        distanceLabel.rightAnchor.constraint(equalTo: parkingImageView.leftAnchor).isActive = true
        ...
        spotLocatingLabel.rightAnchor.constraint(equalTo: parkingImageView.leftAnchor).isActive = true
