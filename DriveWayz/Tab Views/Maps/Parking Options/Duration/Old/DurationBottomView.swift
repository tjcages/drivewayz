    ...
    @objc func buttonPressed(sender: UIButton) {
        if sender == parkNowButton {
            ...
            UIView.animate(withDuration: animationIn) {
                ...
                self.reserveSpotButton.setTitleColor(Theme.BLACK, for: .normal)
                self.reserveSpotButton.tintColor = Theme.BLACK
            ...
            UIView.animate(withDuration: animationIn) {
                ...
                self.parkNowButton.setTitleColor(Theme.BLACK, for: .normal)
                self.parkNowButton.tintColor = Theme.BLACK
                self.view.layoutIfNeeded()
            }
        }
    }
