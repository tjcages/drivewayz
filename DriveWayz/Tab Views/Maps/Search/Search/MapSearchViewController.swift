...
class MapSearchViewController: UIViewController {
    ...
    func setupCurrent() {
        ...
        currentImageView.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 22).isActive = true
        currentImageView.heightAnchor.constraint(equalToConstant: 22).isActive = true
        ...
        currentLabel.leftAnchor.constraint(equalTo: currentImageView.rightAnchor, constant: 16.5).isActive = true
    ...
    @objc func currentLocationPressed() {
        ...
        self.delegate?.zoomToSearchLocation(address: "Current location")
    }
    
    func bringCurrentLocation() {
        self.tableTopAnchor.constant = 50
    ...
    func hideCurrentLocation() {
        self.tableTopAnchor.constant = 0
        UIView.animate(withDuration: animationOut) {
...
extension MapSearchViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row < 2 && recentItems.count > 1 {
            ...
            cell.pinImageView.backgroundColor = Theme.DARK_GRAY.withAlphaComponent(0.2)
            ...
            if indexPath.row < matchingItems.count {
                ...
                if let currentLocation = userMostRecentLocation {
                    ...
                    placesClient.lookUpPlaceID(placeID) { (place, error) in
                        ...
                        if miles <= 50 {
                            let distanceString = String(format: "%.1f miles", miles)
