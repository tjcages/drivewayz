...
class DrivewayzMessagesViewController: UIViewController {
    ...
    var gradientContainerHeightAnchor: NSLayoutConstraint!
    ...
    func setupViews() {
        ...
        gradientContainerHeightAnchor = gradientContainer.heightAnchor.constraint(equalToConstant: phoneHeight)
            gradientContainerHeightAnchor.isActive = true
        ...
        durationLabel.bottomAnchor.constraint(equalTo: gradientContainer.bottomAnchor, constant: -12).isActive = true
        ...
        mainLabel.bottomAnchor.constraint(equalTo: durationLabel.topAnchor, constant: -2).isActive = true
    ...
    func openMessageBar() {
        switch device {
        case .iphone8:
            self.gradientContainerHeightAnchor.constant = 160
        case .iphoneX:
            self.gradientContainerHeightAnchor.constant = 180
        }
    ...
    func closeMessageBar() {
        ...
        self.gradientContainerHeightAnchor.constant = phoneHeight
...
extension DrivewayzMessagesViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension DrivewayzMessagesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension DrivewayzMessagesViewController: UITextViewDelegate {
