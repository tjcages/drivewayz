...
class ParkingCurrentViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, notificationOptions {
    ...
    func setupViews() {
        ...
        currentTableView.widthAnchor.constraint(equalTo: parkingView.widthAnchor, constant: -10).isActive = true
        ...
        detailsTableView.widthAnchor.constraint(equalTo: parkingView.widthAnchor, constant: -10).isActive = true
        ...
        paymentTableView.widthAnchor.constraint(equalTo: parkingView.widthAnchor, constant: -10).isActive = true
