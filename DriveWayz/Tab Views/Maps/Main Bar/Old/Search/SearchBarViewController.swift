...
class SearchBarViewController: UIViewController {
    ...
    var searchButton: UIButton = {
        ...
        button.tintColor = Theme.GREEN.withAlphaComponent(0.7)
    ...
    var fromSearchIcon: UIView = {
        ...
        view.layer.borderColor = Theme.SALMON.withAlphaComponent(0.7).cgColor
    ...
    var switchSearchButton: UIButton = {
        ...
        button.layer.borderColor = Theme.GRAY_WHITE.withAlphaComponent(0.2).cgColor
