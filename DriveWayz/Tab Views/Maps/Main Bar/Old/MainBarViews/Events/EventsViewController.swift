...
class EventsViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, CLLocationManagerDelegate {
    
    let identifier = "identifier"
    let locationManager = CLLocationManager()
    var localEvents: [LocalEvents] = []
    lazy var cellWidth: CGFloat = 300
    ...
    lazy var eventsPicker: UICollectionView = {
        ...
        picker.contentInset = UIEdgeInsets(top: 0, left: 12, bottom: 0, right: 0)
    ...
    var ticketMaster: UIButton = {
        ...
        button.setTitleColor(Theme.BLACK.withAlphaComponent(0.6), for: .normal)
    ...
    var seeMoreLabel: UIButton = {
        ...
        button.setTitleColor(Theme.COOL_2_MED.withAlphaComponent(0.6), for: .normal)
...
//        smallEventsPicker.dataSource = self
    ...
    func setupViews() {
        ...
        eventsPickerHeightAnchor = eventsPicker.heightAnchor.constraint(equalToConstant: cellHeight + 16)
...
//                cell.mainLabel.text = localEvents[indexPath.row].name
...
//        }
    ...
    func checkParkingOptions(text: String) {
        ...
        if text.contains("$") {
            ...
            attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.COOL_2_MED , range: range)
            ...
            attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: Theme.BLUE , range: hourlyRange)
