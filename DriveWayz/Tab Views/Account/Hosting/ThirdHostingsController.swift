...
class ThirdHostingsController: UIViewController, handleNewHosting {
...
extension ThirdHostingsController: handleHostEditing {
    ...
    func hideEditingAmenities() {
        self.hostDelegate?.hideEditingAmenities()
    }
    ...
    func hideEditingSpots() {
        self.hostDelegate?.hideEditingSpots()
    }
    ...
    func hideEditingCost() {
        self.hostDelegate?.hideEditingCost()
    }
    ...
    func hideEditingInformation() {
        self.hostDelegate?.hideEditingInformation()
    }
    ...
    func hideEditingCalendar() {
        self.hostDelegate?.hideEditingCalendar()
    }
