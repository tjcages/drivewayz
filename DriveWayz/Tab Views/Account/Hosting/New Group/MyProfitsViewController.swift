...
class MyProfitsViewController: UIViewController {
    ...
    func setupViews() {
        ...
        transferButton.rightAnchor.constraint(equalTo: container.rightAnchor, constant: -12).isActive = true
        transferButton.heightAnchor.constraint(equalToConstant: 50).isActive = true
        transferButton.widthAnchor.constraint(equalToConstant: 120).isActive = true
