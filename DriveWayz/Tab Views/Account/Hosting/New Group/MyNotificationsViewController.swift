...
class MyNotificationsViewController: UIViewController {
    ...
    var notifications: [HostNotifications] = [HostNotifications(profileImageURL: UIImage(named: "background4"), title: "Neville messaged you", subtitle: "I am waiting", date: "23 min"), HostNotifications(profileImageURL: UIImage(named: "background4"), title: "Congratulations!", subtitle: "You got 5 stars from Lennert", date: "1 hr"), HostNotifications(profileImageURL: UIImage(named: "background4"), title: "Lennert messaged you", subtitle: "Great! I am coming that way.", date: "1 hr")]
    ...
    func setupViews() {
        ...
        notificationsTableView.topAnchor.constraint(equalTo: reservationLabel.bottomAnchor, constant: 2).isActive = true
