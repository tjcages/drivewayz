...
class HostingGraphsViewController: UIViewController, ChartViewDelegate {
    ...
    func setupViews() {
        ...
        chartView.rightAnchor.constraint(equalTo: container.rightAnchor, constant: 22).isActive = true
        chartView.leftAnchor.constraint(equalTo: container.leftAnchor, constant: -21).isActive = true
