...
class HelpEarningsController: UIViewController {

    var delegate: HostHelpDelegate?
    var mainColor: UIColor = UIColor(red: 66/255, green: 67/255, blue: 106/255, alpha: 1.0)
    ...
    lazy var gradientController: GradientContainerView = {
        ...
        controller.scrollViewHeight = 2110
    ...
    var subLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Watch the cash flow in, promote \nyour spot in-app, or monitor \nanalytics with ease."
        label.textColor = Theme.WHITE
    ...
    var learnContainer: UIView = {
        ...
        view.backgroundColor = UIColor(red: 146/255, green: 205/255, blue: 244/255, alpha: 1.0)
    ...
    var mainGraphic: UIImageView = {
        ...
        let image = UIImage(named: "hostHelpEarnings")
        view.image = image
    ...
    var informationController = HelpEarningsInformationView()
    ...
    override func viewDidAppear(_ animated: Bool) {
        gradientController.animateText(text: "Earnings")
    ...
    func setupViews() {
        ...
        mainGraphic.heightAnchor.constraint(equalTo: mainGraphic.widthAnchor, multiplier: 1.02667).isActive = true
...
extension HelpEarningsController: UIScrollViewDelegate {
