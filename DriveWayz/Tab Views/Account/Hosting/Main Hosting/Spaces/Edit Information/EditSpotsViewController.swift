...
class EditSpotsViewController: UIViewController {
    ...
    func setupViews() {
        ...
        container.addSubview(numberController.view)
        numberController.view.topAnchor.constraint(equalTo: parkingLabel.bottomAnchor, constant: 12).isActive = true
        numberController.view.bottomAnchor.constraint(equalTo: container.bottomAnchor, constant: -24).isActive = true
        numberController.view.centerXAnchor.constraint(equalTo: container.centerXAnchor).isActive = true
        numberController.view.widthAnchor.constraint(equalTo: container.widthAnchor).isActive = true
