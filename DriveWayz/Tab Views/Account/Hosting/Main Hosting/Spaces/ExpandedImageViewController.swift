...
class ExpandedImageViewController: UIViewController {
    ...
    lazy var scrollView: UIScrollView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: 0, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
    ...
    lazy var secondImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 1, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
    ...
    lazy var thirdImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 2, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 2, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var fourthImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 3, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 3, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var fifthImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 4, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 4, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var sixthImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 5, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 5, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var seventhImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 6, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 6, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var eighthImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 7, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 7, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var ninethImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 8, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 8, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    lazy var tenthImageView: UIImageView = {
        ...
        switch device {
        case .iphone8:
            view.frame = CGRect(x: scrollView.frame.width * 9, y: 0, width: self.view.frame.width, height: 280)
        case .iphoneX:
            view.frame = CGRect(x: scrollView.frame.width * 9, y: 0, width: self.view.frame.width, height: 300)
        }
        view.clipsToBounds = true
    ...
    func setData(hosting: ParkingSpots) {
        if let hostingImage = hosting.ParkingImages {
            ...
            scrollView.contentSize = CGSize(width: phoneWidth * CGFloat(hostingImage.count), height: 200)
        }
    }
    ...
    func setupViews() {
        ...
        scrollView.addSubview(firstImageView)////////////////////JUST FOR TESTING
        scrollView.addSubview(secondImageView)////////////////////JUST FOR TESTING
        scrollView.contentSize = CGSize(width: phoneWidth * 2, height: 200)
