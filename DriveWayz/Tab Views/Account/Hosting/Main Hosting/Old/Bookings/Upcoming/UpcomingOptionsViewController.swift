...
class UpcomingOptionsViewController: UIViewController {

    var delegate: changeBookingOptions?
    var keyboardHeight: CGFloat = 0.0
    var previousMessageHeight: CGFloat = 0.0
    
    // Potential options for payout issues the user may be experiencing
    let mainArray: [String] = ["Payments in transit", "My payout information is incorrect", "My bank does not show the payment was received", "Contact support"]
    let subArray: [String] = ["In general, payments take 2-3 business days to transfer from Drivewayz' account to your account. Payments that have not yet shown up in your bank account may be in transit or delayed so we suggest waiting up to 5 business days from when the payment was initiated. Please contact Drivewayz if the payment has not shown up after the suggested arrival time.", "If the payout information is incorrect it likely means that the payout failed or has been transferred to an incorrect account. We will review your payout information and attempt to fix the incorrect account if it has not already arrived in the incorrect account.", "Payment transfers generally take between 2-3 business days to show up in your bank account. If it has been longer than 2-3 business days then Drivewayz will review the payout information and reach out to you with further details.", "Please contact Drivewayz with any relevent payout information in regards to the issue that you are currently experiencing."]
...
extension UpcomingOptionsViewController {
...
extension UpcomingOptionsViewController: UITextViewDelegate {
