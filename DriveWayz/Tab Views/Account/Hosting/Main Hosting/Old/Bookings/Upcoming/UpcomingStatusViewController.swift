//
//  UpcomingStatusViewController.swift
//  DriveWayz
//
...
protocol changeBookingOptions {
    func changeOptionsHeight(amount: CGFloat)
    func dismissView()
}

class UpcomingStatusViewController: UIViewController {
    ...
    var receiveButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.backgroundColor = Theme.WHITE
        button.setTitle("Need to cancel current booking", for: .normal)
        button.setTitleColor(Theme.BLACK, for: .normal)
        button.titleLabel?.font = Fonts.SSPRegularH5
        button.addTarget(self, action: #selector(optionsPressed(sender:)), for: .touchUpInside)
    ...
    var incorrectButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.backgroundColor = Theme.WHITE
        button.setTitle("Remind driver to leave", for: .normal)
        button.setTitleColor(Theme.BLACK, for: .normal)
        button.titleLabel?.font = Fonts.SSPRegularH5
        button.addTarget(self, action: #selector(optionsPressed(sender:)), for: .touchUpInside)
    ...
    var transitButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.backgroundColor = Theme.WHITE
        button.setTitle("What does overstay mean?", for: .normal)
        button.setTitleColor(Theme.BLACK, for: .normal)
        button.titleLabel?.font = Fonts.SSPRegularH5
        button.addTarget(self, action: #selector(optionsPressed(sender:)), for: .touchUpInside)
    ...
    lazy var transferOptions: UpcomingOptionsViewController = {
        let controller = UpcomingOptionsViewController()
    ...
    @objc func optionsPressed(sender: UIButton) {
        ...
        if sender == self.transitButton {
            ...
            self.transferOptionsHeightAnchor.constant = 266
            self.transferOptions.noMessage()
        } else if sender == self.incorrectButton {
            ...
            self.transferOptions.noMessage()
        } else if sender == self.receiveButton {
            ...
            self.transferOptionsHeightAnchor.constant = 301
            self.transferOptions.mainButton.alpha = 1
            self.transferOptions.noMessage()
        } else if sender == self.issueButton {
            ...
            self.transferOptionsHeightAnchor.constant = 260
            self.transferOptions.mainButton.alpha = 0
...
extension UpcomingStatusViewController: changeBookingOptions {
