...
class ListingInformationView: UIViewController {

    var delegate: HandleListingDetails?
    lazy var bottomAnchor: CGFloat = cancelBottomHeight
    var shouldDismiss: Bool = true
    
    var information: [ListingInformation] = [ListingInformation(main: "Your spot number is hidden until a driver books the space", sub: "Spot numbers can generally be found at the base of the parking space or on a sign in front.", information: "Each spot is booked individually."), ListingInformation(main: "Your gate code is hidden until a driver books the space", sub: "Only enter a gate code if it is absolutely necessary to entering the parking space.", information: "You can always disable gate code later.")]
