...
class HostOnboardingController: UIViewController {
    ...
    @objc func dismissController() {
        ...
        delegate?.dismissActiveController()
    }
...
extension HostOnboardingController: UIAdaptivePresentationControllerDelegate {
...
extension HostOnboardingController: UIScrollViewDelegate {
