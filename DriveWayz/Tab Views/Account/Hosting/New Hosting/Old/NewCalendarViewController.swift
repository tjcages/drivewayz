...
class NewCalendarViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func setupViews() {
        ...
        scheduleLabel.topAnchor.constraint(equalTo: calendar.topAnchor, constant: -24).isActive = true
...
class CalendarCell: UICollectionViewCell {
    ...
    lazy var leftView: UIView = {
        let view = UIView(frame: CGRect(x: 0, y: 0.5, width: 1, height: self.frame.height - 1))
        //        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = Theme.BLACK.withAlphaComponent(0.5)
    ...
    lazy var rightView: UIView = {
        let view = UIView(frame: CGRect(x: self.frame.width - 1, y: 0.5, width: 1, height: self.frame.height - 1))
        //        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = Theme.BLACK.withAlphaComponent(0.5)
...
//        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setupViews() {
        ...
        self.addSubview(cellLabel)
        self.addSubview(bottomView)
        cellLabel.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 20).isActive = true
        cellLabel.rightAnchor.constraint(equalTo: self.rightAnchor).isActive = true
        cellLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        cellLabel.sizeToFit()
