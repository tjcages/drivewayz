...
class ConfirmAvailabilityView: UIViewController {
    ...
    var mainLabel: UILabel = {
        ...
        label.text = "Please make sure your parking spot is completely empty for the times specified"
    ...
    var subLabel: UILabel = {
        ...
        label.numberOfLines = 10
        label.text = "Issues with drivers will generally lower your overall ranking."
    ...
    var informationLabel: UILabel = {
        ...
        label.text = "You can always adjust availability later."
