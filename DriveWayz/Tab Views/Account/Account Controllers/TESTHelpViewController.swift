...
class TESTHelpViewController: UIViewController {
...
//    var options: [String] = ["Driver Overstay Options", "Issues With Motorists", "Contact Drivewayz", "Privacy Policy", "Release Notes", "Terms & Conditions", "Frequently Asked Questions", "More"] {
//        didSet {
//            optionsTableView.reloadData()
//        }
//    }
...
extension TESTHelpViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension TESTHelpViewController: UITableViewDelegate, UITableViewDataSource {
...
extension TESTHelpViewController: UIScrollViewDelegate {
