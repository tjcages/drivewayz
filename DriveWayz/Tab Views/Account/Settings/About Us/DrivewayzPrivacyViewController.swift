...
class DrivewayzPrivacyViewController: UIViewController, UIScrollViewDelegate {
    ...
    func setupViews() {
        ...
        agreementHeight = privacyPolicy.text?.height(withConstrainedWidth: phoneWidth - 42, font: Fonts.SSPRegularH6)
        ...
        privacyPolicy.heightAnchor.constraint(equalToConstant: agreementHeight! + 200).isActive = true
