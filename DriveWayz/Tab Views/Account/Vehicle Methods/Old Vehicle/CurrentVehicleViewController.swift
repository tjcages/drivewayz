...
class CurrentVehicleViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        if deleteButton.alpha == 0 {
            vehicleMakeLabel.becomeFirstResponder()
        }
    }
    ...
    func setupViews() {
        ...
        grayView.heightAnchor.constraint(equalToConstant: 16).isActive = true
    ...
    func setupNewVehicle() {
        ...
        vehicleModelLabel.text = ""
        vehicleYearLabel.text = ""
        vehicleLicenseLabel.text = ""
        currentButton.setTitle("Confirm vehicle", for: .normal)
        currentButton.setTitleColor(Theme.BLUE, for: .normal)
        detailLabel.text = "Enter details"
        doneButton?.title = "Next"
        makeLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        modelLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        yearLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        licenseLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        vehicleMakeLabel.isUserInteractionEnabled = true
        vehicleModelLabel.isUserInteractionEnabled = true
        vehicleYearLabel.isUserInteractionEnabled = true
        vehicleLicenseLabel.isUserInteractionEnabled = true
    }
    
    func setupCurrentVehicle() {
        deleteButton.alpha = 1
        checkmark.alpha = 1
        currentButton.setTitle("Make current vehicle", for: .normal)
        currentButton.setTitleColor(Theme.BLACK, for: .normal)
        ...
        yearLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        licenseLabel.textColor = Theme.DARK_GRAY.withAlphaComponent(0.4)
        vehicleMakeLabel.isUserInteractionEnabled = false
        vehicleModelLabel.isUserInteractionEnabled = false
        vehicleYearLabel.isUserInteractionEnabled = false
        vehicleLicenseLabel.isUserInteractionEnabled = false
    }
