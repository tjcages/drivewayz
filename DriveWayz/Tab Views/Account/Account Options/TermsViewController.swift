...
class TermsViewController: UIViewController, UIScrollViewDelegate {
    ...
    var agreement: UILabel = {
        ...
        This set of DriveWayz Terms & Conditions (this “Terms & Conditions”) applies to any and all use of (1) the DriveWayz website at http://drivewayz.app/ and all affiliated websites owned and operated solely by DriveWayz (collectively, the DriveWayz LLC.”), (2) the parking reservation services made available by DriveWayz through the DriveWayz Mobile Apps (collectively, DriveWayz Mobile App) any DriveWayz-branded application for your mobile or other device, and any other online properties of DriveWayz or third parties, as described in Part I below (the “Reservation Services”), and (3) any other services or features made available by DriveWayz through the DriveWayz Site or any DriveWayz Mobile Application. Together, the items in (1) through (3) are referred to herein as the “Services”.
