...
class UserParkingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, sendBankAccount {
    ...
    var currentParkingImageView: UIImageView = {
        ...
        currentParkingImageView.alpha = 0
...
//            self.delegate?.changeCurrentView(height: 100)
    ...
    func setupViews() {
        ...
        parkingTopAnchorSmall = newParkingPage.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 70)
            parkingTopAnchorSmall.isActive = true
        parkingTopAnchorTall = newParkingPage.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 390)
    ...
    func setupCurrent() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.3, animations: {
                ...
                self.earningsController.view.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 30).isActive = true
                ...
                self.availabilityController.view.topAnchor.constraint(equalTo: self.earningsController.view.bottomAnchor, constant: 120).isActive = true
